# VLC Stream Keeper  
Keeps a camera stream running in VLC.

## Description
This script is used to ensure an RTSP camera stream is displayed on a small
...
python3 vlcstreamkeeper.py
```

## Version Notes:  
This is the inital version and is in testing.
